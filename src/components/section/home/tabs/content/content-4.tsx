        ...
        <>
            ...
            <div className="flex flex-col justify-between gap-6 xl:flex-row">
                ...
                <div className="relative flex flex-col items-center gap-6">
                    <span className="xl:bg-card-transform-4 relative block h-[546px] w-full rounded-2xl bg-content-2 bg-cover bg-center md:max-w-[358px] xl:h-[660px] xl:min-w-[526px]" />
